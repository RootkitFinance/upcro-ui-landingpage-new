...
export function Updater() {
  const [state]:any = useLocalStorageContext()
...
export function useDarkModeManager() {
  const [state, { updateKey }]:any = useLocalStorageContext()
...
export function usePathDismissed(path:any) {
  const [state, { updateKey }]:any = useLocalStorageContext()
...
export function useSavedPairs() {
  ...
  function addPair(address:any, token0Address:any, token1Address:any, token0Symbol:any, token1Symbol:any) {
  ...
  function removePair(address:any) {
    let newList = state?.[SAVED_PAIRS]
...
export function useSavedTokens() {
  ...
  function addToken(address:any, symbol:any) {
  ...
  function removeToken(address:any) {
    let newList = state?.[SAVED_TOKENS]
    newList[address] = null
    updateKey(SAVED_TOKENS, newList)
  }
